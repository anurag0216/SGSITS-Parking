   ...
   <div class="container">
         ...
         <div class="cart-nav col-xs-4">
           <ul>
             ...
             <!-- <li class="list-group-item" id="requests"><a><span class="glyphicon glyphicon-edit"></span> Generate Bill</a></li> -->
             <li class="list-group-item" id="requests"><a href="booking_history.php"><span class="glyphicon glyphicon-calendar"></span> Booking History</a></li>
             <!-- <li class="list-group-item" id="requests"><a><span class="glyphicon glyphicon-phone-alt"></span> Contact Us</a></li> -->
             <li class="list-group-item" id="requests"><a href="contact_attendant.php"><span class="glyphicon glyphicon-earphone"></span> Contact Us</a></li>
             <!-- <li class="list-group-item" id="requests"><a><span class="glyphicon glyphicon-envelope"></span> Notifications</a></li> -->
             <li class="list-group-item" id="requests"><a href="contact_attendant.php"><span class="glyphicon glyphicon-earphone"></span> Register Parking Space</a></li>
