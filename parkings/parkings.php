...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <!-- <button class="btn btn-default" data-backdrop="false" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">View Location</button> -->
    <a href="https://maps.app.goo.gl/Nepdb6MdYrnWoJXN7" target="_blank" class="btn btn-default">View Location</a>
    <button class="btn btn-default" data-backdrop="false" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Extend Time</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="select<?=$parking_id; ?>">Request Slot</button>
      </div>
    </div>
  </div>
</div>
  ...
  $('#hour<?=$parking_id; ?>').keyup(function(){
        ...
        if( Number(remaining) > 0 ){
           ...
           $("#total<?=$parking_id; ?>").html("Cannot Add A Value");
            $("#select<?=$parking_id;?>").prop('disabled', false).attr('class', 'btn btn-primary').html('Request Slot');
        }else{
...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <!-- <button class="btn btn-default" type="button" data-backdrop="false" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">View Location</button> -->
    <a href="https://maps.app.goo.gl/Nepdb6MdYrnWoJXN7" target="_blank" class="btn btn-default">View Location</a>
    <button class="btn btn-default" type="button" data-backdrop="false" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Extend Time</button>
