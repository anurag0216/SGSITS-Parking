...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <!-- <button class="btn btn-default" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">View Location</button> -->
    <a href="https://maps.app.goo.gl/Nepdb6MdYrnWoJXN7" target="_blank" class="btn btn-default">View Location</a>
    <button class="btn btn-default" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Extend Time</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item total"  ><div id="total<?=$parking_id; ?>"> ₹<?=$parking_slot; ?> Total Cost</div></li>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Request Slot</button>
      </div>
    </div>
  </div>
</div>
  ...
  $('#hour<?=$parking_id; ?>').keyup(function(){
        ...
        if( Number(remaining)> 0 ){
           ...
           $("#select<?=$parking_id;?>").prop('disabled', true).attr('class', 'btn btn-danger').html('Disabled...');
            ...
            $("#total<?=$parking_id; ?>").html("₹ "+total+" TOTAL COST");
