      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
                ...
                <td><a href="attendant_Edit2.php? edit=<?php echo $id_attendant; ?>">Edit</a</td>
                <td><a href="attendants.php?delete=<?php echo $id_attendant; ?>">Delete</a></td>
                </tr>
                <?php }?>
                </table>
                <?php
                if(isset($_GET['delete']))
                {
                  ...
                  if($run_delete)
                  {
                    ...
                    echo "<script>window.open('attendants.php','_self')</script>";
                  }
                }
                ?>
	                  	  </div>
